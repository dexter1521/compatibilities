...
<style>
    ...
    .td-marca { font-weight: 700; color: var(--compat-accent-dark); }
    .td-modelo { font-weight: 600; }
    .td-years { font-size: 12.5px; color: #6b7280; white-space: nowrap; }
    .td-cc { font-size: 12px; color: #9ca3af; }
